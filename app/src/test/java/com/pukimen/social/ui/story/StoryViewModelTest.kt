...
import com.pukimen.social.DataDummy
import com.pukimen.social.MainDispatcherRule
import com.pukimen.social.data.remote.response.ListStoryItem
import com.pukimen.social.data.repository.StroyRepository
import com.pukimen.social.getOrAwaitValue
...
import org.mockito.junit.MockitoJUnitRunner
    ...
    class StoryViewModelTest{
        ...
        @Mock
        private lateinit var storyRepository: StroyRepository
        @Test
        fun `when Get Quote Should Not Null and Return Data`() = runTest {
            ...
            val differ = AsyncPagingDataDiffer(
                diffCallback = StroyAdapter.DIFF_CALLBACK,
        ...
        fun `when Get Quote Empty Should Return No Data`() = runTest {
            ...
            val actualQuote: PagingData<ListStoryItem> = mainViewModel.getAllStory.getOrAwaitValue()
            val differ = AsyncPagingDataDiffer(
                diffCallback = StroyAdapter.DIFF_CALLBACK,
                updateCallback = noopListUpdateCallback,
                workerDispatcher = Dispatchers.Main,
